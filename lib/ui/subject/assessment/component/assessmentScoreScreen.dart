...
import 'package:lms_v_2_0_0/ui/subject/assessment/component/assessmentAnswerScreen.dart';
...
class AssessmentScoreScreen extends StatefulWidget {
  ...
  const AssessmentScoreScreen(this.points, this.length, this.globalOptionStates,
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            Center(
              child: SizedBox(
                ...
                child: SvgPicture.asset(
                  'assets/img/assessment/assessmentScore.svg',
                  fit: BoxFit.contain,
                ),
              ),
            ),
            ...
            Center(
              child: Text(
                'Your Assessment have been submitted!',
                style: TextStyle(
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      ScaleInRoute(
                        page: AssessmentAnswerScreen(
                            widget.assessmentQuestionList,
