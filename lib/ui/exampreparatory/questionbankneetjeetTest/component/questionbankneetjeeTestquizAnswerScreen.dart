...
class ExampreparatoryNeetJeeQuizAnswerScreen extends StatefulWidget {
  final Future<List<ExampreparatoryQuestions>>? exampreparatoryTestQuestionList;
  final List<List<bool>> globalOptionStates;
  const ExampreparatoryNeetJeeQuizAnswerScreen(
      this.exampreparatoryTestQuestionList, this.globalOptionStates,
      {super.key});

  @override
  State<ExampreparatoryNeetJeeQuizAnswerScreen> createState() =>
      _ExampreparatoryNeetJeeQuizAnswerScreenState();
}

class _ExampreparatoryNeetJeeQuizAnswerScreenState
    extends State<ExampreparatoryNeetJeeQuizAnswerScreen> {
  @override
