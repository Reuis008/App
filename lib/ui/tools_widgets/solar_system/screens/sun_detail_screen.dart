    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          mainContent(height, width, topic.imageSrc, topic.imageHeroTagName,
              sunData, context),
        ],
      ),
    );
...
Widget heroBackground(
    double height, double width, String bgTag, List<Color> gradient) {
  return Hero(
      tag: bgTag,
      child: Container(
          height: height,
...
Widget mainContent(double height, double width, String imageSrc,
    String heroImageTagName, Sun data, BuildContext context) {
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    "Distance from Earth : ${data.distanceFromEarth} million km",
                    style: style,
                  ),
                  ...
                  Text(
                    "Volume : ${data.volumeCompareToEarth} x Earth",
                    style: style,
                  ),
                  Text(
                    "Age: ${data.age} billion years",
                    style: style,
                  ),
                  Text(
                    "Surface Temperature: ${data.surfaceTemp} Kelvin",
                    style: style,
                  )
                ],
              ),
