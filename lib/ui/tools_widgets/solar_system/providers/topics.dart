...
class Topics with ChangeNotifier {
  final List<Topic> _topics = [
    Topic(
        ...
        gradient: [const Color(0xFFD20B54), const Color(0xFFFFB849)],
    ...
    Topic(
        ...
        gradient: [const Color(0xFF303395), const Color(0xFF27F0F0)],
    ...
    Topic(
        ...
        gradient: [const Color(0xFF05974A), const Color(0xFFF2E51E)],
    ...
    Topic(
        ...
        gradient: [const Color(0xFF2D266F), const Color(0xFF7C2289)],
    ...
    Topic(
        ...
        gradient: [const Color(0xFFF48731), const Color(0xFFD8E015)],
