...
class CometsData with ChangeNotifier {
  final Comet _cometsData = Comet(
      ...
      partsOfComet: {
        ...
        'data': [
          Data('Nucleus',
              "The nucleus of a comet is composed of ice and rocky material. The nucleus of most comets ranges from about 10 to 100 km in diameter, though they can be as large as 100 km in diameter."),
          Data('Coma',
          ...
          Data('Ion Tail',
              "The ion tail is a stream of ionized gases that are blown directly away from the Sun as a result of the comet’s contact with the solar wind."),
        ]
      },
      famousComets: {
        ...
        'data': [
          ...
          Data('Comet Hale-Bopp',
              "Comet Hale-Bopp is best known to most people for the much publicized Californian cult who believed the comet to be a spacecraft. Comet Hale-Bopp was last visible in 1997 and will not be visible again for approximately 2,300 years. It is named after its co-discoverers, Alan Hale and Thomas Bopp."),
          Data('Comet Shoemaker-Levy 9',
