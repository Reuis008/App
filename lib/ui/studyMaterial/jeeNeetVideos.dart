...
import 'package:lms_v_2_0_0/ui/studyMaterial/videoList/unitList.dart';

class JeeNeetVideos extends StatefulWidget {
  ...
  @override
  State<JeeNeetVideos> createState() => _JeeNeetVideosState();
}

class _JeeNeetVideosState extends State<JeeNeetVideos>
    with SingleTickerProviderStateMixin {
  int count = 0;
  Future<List<VideosSubjectNEETJEE>>? videosSubjectUnitList;
  ...
  void _initializeDBAndData() async {
    ...
    setState(() {
      videosSubjectUnitList = appDB.getVideosSubjectUnitsNEETJEE();
    });
  }
          ...
          child: Scaffold(
            body: TabBarView(
              ...
              children: [
                ...
                UnitList(
                  widget.selectedValue == "JEEVid" ? 'Mathematics' : 'Biology',
                  videosSubjectUnitList,
                  widget.metawords,
                  widget.name,
                  widget.selectedValue,
